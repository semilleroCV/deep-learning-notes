...
GENERIC_PAPER_BADGE_PATTERN = "[![Paper](https://img.shields.io/badge/Paper-Link-blue)]({})"
...
class TableEntry:
    ...
    def format(self) -> str:
        ...
        if self.paper_url and "arxiv.org" in self.paper_url:
            arxiv_id = self.paper_url.split("/")[-1]
            paper_badge = ARXIV_BADGE_PATTERN.format(arxiv_id, arxiv_id)
        else:
            paper_badge = GENERIC_PAPER_BADGE_PATTERN.format(self.paper_url) if self.paper_url else ""
